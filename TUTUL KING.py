#••••••••••••••••••••••••••••••••••••••••••••••••••••••••
#-[ TOOL - TUTUL PAID v16 ]••••••••••••••••••
#-[ DECODED BY - ERRORxLMNx9 ]••••••••••
#-[ BUG FIXED BY - @DARK_LMNx999 ]•••
#••••••••••••••••••••••••••••••••••••••••••••••••••••••••
...
{lal}╠══[Facebook                 • Tutul King ]   ║    
{A}╠══[Github                   • Tutul-King ]   ║   
{নীল}╠══[Whatsapp                 • 01611860222 ]  ║ 
{গোলাপি}╠══[TOOLS                    • PAID ]         ║    
{হলুদ}╠══[VERSION                  • 16.0 ]         ║ \033[10;92m
...
def login():
    ...
    sy = requests.get('https://graph.facebook.com/me?fields=id,name&access_token=' + tokenku[0], cookies = {W9}
        'cookie': W9 })
...
def login_lagi334():
    try:
        ...
        tok = re.search('accessToken="(AKAS)"', str(roq.content)).group(1)
...
def menu():
    ...
    if TUTUL in ('111',):
        ...
        os.system('xdg-open Akasonfire11')
        menu()
    elif TUTUL in ('0',):
